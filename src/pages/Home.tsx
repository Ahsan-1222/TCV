...
export const Home = () => {
  ...
  return (
    <div className="bg-[#0A0A0A]">
      ...
      <section className="bg-[#111111] border-t border-b border-white/5 py-14 md:py-28 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12">
          <div className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">

            {/* 3D Parallax Image */}
            <ScrollReveal direction="left" distance={40} duration={0.95}>
              <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] md:aspect-[4/3] lg:aspect-[16/10] max-h-[500px] overflow-hidden rounded-md border border-crown-gold/30 shadow-[0_20px_50px_rgba(0,0,0,0.9),0_0_35px_rgba(201,168,106,0.18)] bg-[#0E0E0E]">
                <ScrollParallax speed={0.1} offset={20} className="w-full h-full">
                  <img
                    src="/assets/products/trio-bundle.jpg"
                    alt="Signature Trio Bundle"
                    className="w-full h-full object-cover object-center contrast-[1.06] brightness-[1.03] scale-105 transition-transform duration-700 hover:scale-110 block"
                  />
                </ScrollParallax>
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A]/50 via-transparent to-white/5 pointer-events-none" />
            ...
            {/* Text Content */}
            <ScrollReveal direction="right" distance={40} duration={0.95} delay={0.15}>
              <div className="flex flex-col justify-center">
                <div className="text-[9px] tracking-[0.4em] uppercase text-crown-gold mb-4 flex items-center gap-2">
                  <span className="h-px w-5 bg-crown-gold/60 inline-block" />
                  Curated Bundle
                </div>
